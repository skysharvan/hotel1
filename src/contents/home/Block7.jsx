    ...
    <Box sx={{margin:'30px 0px',background:'#fff',padding:{md:'30px', sm:'20px',xs:'5px'}}}>
        <Box sx={{display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center',}}>
            ...
            <Box sx={{padding:'15px',opacity:'0.7'}}>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}>We’re a hotel operator in the industry, meanwhile, we are independent hotels like you too. We deeply know and care about your concerns regarding hotel</Typography>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}> abroad as there still some uncertainty outside the world. To provide you with updated news and professional advice, our hotel specialists monitor and collect first-</Typography>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}>hand information about all of our destinations every day. And, we are now releasing our Book with Confidence and hotel with Confidence programs that we</Typography>
            ...
            <Card sx={{width:{xs:'100%',sm:'600px',md:'700px',lg:'920px'},marginTop:'30px'}}>
              ...
              <Box sx={{display:'flex',flexDirection:'column',alignItems:'center',padding:'7px'}}>
                ...
                <Typography sx={{fontSize:{md:'18px',xs:'16px'}}}>senior manager </Typography>
              </Box >
