  ...
  return(
    <>
      <Box sx={{background:'#fff',marginBottom:'0px'}}>
         ...
         <Typography sx={{fontSize:{md:'45px',sm:'30px',xs:'25px'},display:'flex',justifyContent:'center',margin:'15px 0px',padding:{xs:'0px 15px',sm:'0px 20px',md:'15px'}}}>Where You want to stay with our Specialities.</Typography>
         <Box sx={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',padding:{xs:'15px 15px',sm:'0px 20px',md:'15px',lg:'10px',xl:'10px'}}}>
            <Typography sx={{fontSize:{md:'20px',xs:'16px'} }}>hotels are typically funded by public funding, health organisations (for-profit or nonprofit), health insurance</Typography>
            <Typography sx={{fontSize:{md:'20px',xs:'16px'} }}>Currently, hotels are largely staffed by professional physicians, surgeons, nurses, and allied health practitioners, whereas in the past</Typography>
         </Box>
      </Box>
    </>
  ) 
